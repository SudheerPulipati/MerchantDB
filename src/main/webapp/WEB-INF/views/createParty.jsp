...
<form action="/merchantdb/saveParty" method="post">
	...
	<table>
		...
		<tr>
			...
			<td><select name="ledgerGroupId" id="ledgerGroupName">
					<c:forEach items="${ledgerGroupList}" var="element">
						<option
							value="${element.ledgGroupID},${element.ledgGroupName},${element.ledgGroupType}">${element.ledgGroupName}</option>
					</c:forEach>
			</select></td>
		</tr>
		<tr>
			<td>City Group</td>
			<td><select name="cityGroupId" id="cityGroup">
