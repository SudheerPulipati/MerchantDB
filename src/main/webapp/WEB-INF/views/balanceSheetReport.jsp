	...
	$(document)
			.ready(
					function() {
						...
						$("input[name='balSheetDateSelect']")
								.click(
										function() {
											if ($(
													'input:radio[name=balSheetDateSelect]:checked')
													.val() == "onDate") {
												$("#bsFromDateLbl").html(
														"Date ");
												$("#bsToDateLbl").hide();
						...
						$("#balSheetFromDate").datepicker({
							dateFormat : 'yy-mm-dd'
						});
						$("#balSheetToDate").datepicker({
							dateFormat : 'yy-mm-dd'
						});
...
<table style="width: 100%">
	<tr>
		...
		<td><span id="bsFromDateLbl">Date:</span><input type="text"
			...
			id="balSheetToDate" style="display: none"></td>
		<td><input type="button" value="Show" id="showBalSheet">
		</td>
	</tr>
</table>
<div id="balSheetReportContainer">
	<table id="balanceSheetReport" class="display dataTable" border=1
