...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				$("input[name='trailBalDate']").click(
						function() {
							if ($('input:radio[name=trailBalDate]:checked')
									.val() == "onDate") {
								...
								$("#trailBalToDate").hide();
									...
									'input:radio[name=trailBalDate]:checked')
									.val() == "betweenDate") {
				...
				$("#trailBalFromDate").datepicker({
					dateFormat : 'yy-mm-dd'
				});
				$("#trailBalToDate").datepicker({
					dateFormat : 'yy-mm-dd'
				});
...
<table style="width: 100%">
	<tr>
		...
		<td><span id="tbFromDateLbl">Date:</span><input type="text"
			...
			id="trailBalToDate" style="display: none"></td>
		<td><input type="button" value="Show" id="showTrailBal">
		</td>
	</tr>
</table>
<div id="trailBalReportContainer">
	<table id="trailBalanceReport" class="display dataTable" border=1
