...
<div id="cityGroupModal" 
	...
	<span style="font-size: 22px;">City Group Form</span>
		<hr
			...
			align="left" />
	<form method="post" action="/merchantdb/updateCityGroup" style = "margin-left:25%">
	...
	<input type="hidden" name="cityGroupID" />  <input type="submit" value="Remove"> 
</form>
</div>
</div>
</div>