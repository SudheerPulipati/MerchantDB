...
public class BalanceSheetDAO implements IBalanceSheetDAO {
	...
	private static final String BAL_SHEET_RECORDS_QUERY = "SELECT A.LEDGER_NAME,A.DEPOSITTYPE,A.AMOUNT FROM LEDGER A,FIN_BOOK B WHERE A.BOOKID = B.FIB_ID and A.BOOKID = ? and date(A.MODIFIED_DATE) BETWEEN ? AND ?";
