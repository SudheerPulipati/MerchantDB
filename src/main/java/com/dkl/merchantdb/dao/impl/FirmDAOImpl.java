...
public class FirmDAOImpl implements FirmDAO{
	...
	public List<FirmTO> readAllFirmsByFK(Long companyId) {
		return jdbcTemplate.query(READ_ALL_BY_FK,new Object[]{companyId}, new FirmMapper());
	}
	...
	public int updateFirm(FirmTO firmTO) {
		...
		int isUpdated;
		try{
			isUpdated = jdbcTemplate.update(
					UPDATE_FIRM,
					new Object[] { firmTO.getFirmName(),DklUtil.getTodayDate(),firmTO.getFirmID() });
		} catch(Exception e){
			isUpdated = 0;
		}
