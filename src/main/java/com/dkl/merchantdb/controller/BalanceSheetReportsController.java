...
import com.dkl.merchantdb.bo.BalanceSheetReportBO;
...
public class BalanceSheetReportsController {

	@Autowired
	private BalanceSheetReportBO reportsBO;

	@RequestMapping("/balanceSheetReport")
	public String viewCashbookReport() {
		return "balanceSheetReport";
	}

	@RequestMapping("/balanceSheetReportJSON")
	@ResponseBody
	public String viewReportJSON(@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate,
		...
		List<BalanceSheetTO> dataList = reportsBO.readAllBalanceSheetEntries(finBookId, startDate, endDate);
