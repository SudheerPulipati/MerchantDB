...
import com.dkl.merchantdb.bo.PurchaseReportsBO;
...
public class PurchaseReportsController {
	...
	@Autowired
	private PurchaseReportsBO reportsBO;
	...
	@RequestMapping("/purchaseReportJSON")
	@ResponseBody
	public String viewReportJSON(@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate,
		...
		List<PurchaseReportTO> dataList = reportsBO.readAllPurchaseEntries(bookId, startDate, endDate);
