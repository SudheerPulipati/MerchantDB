...
CREATE TABLE `firm` (
  ...
  CONSTRAINT `firm_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `company` (`COMPANY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ledger_account` (
  ...
  CONSTRAINT `fk_led_acc_city_grp` FOREIGN KEY (`city_group_id`) REFERENCES `city_group` (`city_group_id`),
  CONSTRAINT `fk_led_acc_fin_book` FOREIGN KEY (`fib_id`) REFERENCES `fin_book` (`fib_id`),
  CONSTRAINT `fk_led_acc_firm` FOREIGN KEY (`firm_id`) REFERENCES `firm` (`firm_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `party` (
  ...
  CONSTRAINT `fk_party` FOREIGN KEY (`ledger_grp_id`) REFERENCES `ledger_group` (`ledger_grp_id`),
  CONSTRAINT `fk_party_city_group` FOREIGN KEY (`city_group_id`) REFERENCES `city_group` (`city_group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
